...
def level_advice(level: str, systematic: bool) -> str:
    ...
    if level == "AMBER":
        base = ("🟡 <b>Рекомендация:</b> Параллельно подайте документы в школу "
                ...
                "📋 <b>Ст. 127-2 КОАП РК</b> — административная ответственность за буллинг. "
                "Заявление в полицию можно подавать параллельно со школьной жалобой. "
                "Документ 5 из пакета — готовое заявление для этого случая.")
    else:
...
async def show_red_alert(message: Message, state: FSMContext):
    ...
    await message.answer(
        ...
        "5. Фиксируйте всё: фото травм, скриншоты, свидетелей\n\n"
        "⚖️ <b>Важно:</b> с 2024 года тяжкий буллинг — уголовное преступление.\n"
        "Закон РК «О правах женщин и безопасности детей» (15.04.2024) ввёл "
        "уголовную ответственность за систематическое насилие над детьми.\n\n"
