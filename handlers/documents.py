...
async def generate_and_send(message: Message, state: FSMContext):
    ...
    if PAYMENT_ENABLED:
        ...
        kb.button(
            text="📦 Базовый — 3 900 тг (Документы 1–3)",
    ...
    kb2.adjust(1)
    await message.answer(
        "👨‍⚖️ <b>Нужна личная консультация юриста?</b>\n\n"
        "Юрист ADDASTRA разберёт вашу ситуацию, поможет с переговорами "
        "и представит интересы в случае обращения в КПД или прокуратуру.\n\n"
        "Стоимость: <b>25 000 тг</b> за консультацию (60 мин)\n\n"
